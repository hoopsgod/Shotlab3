...
export default function PlayersScreen() {
  ...
  return (
    <div style={{ background: "var(--bg-0)", minHeight: "100vh", padding: "var(--page-gutter)" }}>
      ...
      <p style={{ fontSize: "var(--type-body-size)", color: "var(--text-2)", marginBottom: "var(--space-4)", lineHeight: "var(--type-body-lh)" }}>
      ...
      >
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <span className="type-stat-value">{totalPlayers}</span>
          <span className="type-stat-label" style={{ marginTop: "var(--space-2)" }}>Total</span>
        </div>
        <div style={{ width: "1px", background: "var(--stroke-1)", alignSelf: "stretch" }} />
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <span className="type-stat-value" style={{ color: "var(--accent)" }}>{activePlayers}</span>
          <span className="type-stat-label" style={{ marginTop: "var(--space-2)" }}>Active</span>
        </div>
        <div style={{ width: "1px", background: "var(--stroke-1)", alignSelf: "stretch" }} />
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <span className="type-stat-value" style={{ color: "var(--text-2)" }}>{inactivePlayers}</span>
          <span className="type-stat-label" style={{ marginTop: "var(--space-2)" }}>Inactive</span>
        </div>
      </div>
      ...
      {players.length === 0 ? (
        ...
        >
          ...
          <p className="type-h3" style={{ color: "var(--text-2)", margin: 0 }}>
            No players yet
          </p>
          <p className="type-body-small" style={{ color: "var(--text-2)", textAlign: "center", maxWidth: "260px", margin: 0 }}>
        ...
        filteredPlayers.map((player) => (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div className="type-label" style={{ color: "var(--text-1)", marginBottom: 6 }}>
                {player.name}
              </div>
      ...
      >
        ...
        {copied && <p className="type-caption" style={{ color: "var(--text-2)", margin: 0 }}>Link copied</p>}
      </div>
    </div>
  );
}
