...
.player-home-compact-dashboard{--player-dashboard-gap:14px;gap:var(--player-dashboard-gap);}
...
@media (max-width:767px){
  ...
  .player-home-compact-dashboard{--player-dashboard-gap:10px;margin-bottom:22px;}
}
`;
