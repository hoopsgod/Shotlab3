export default function CoachSimpleHeader({
  ...
  return (
    ...
    >
      <style>{`
        .coach-simple-header-top{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:start;background:transparent;border:0;outline:none;box-shadow:none;}
        .coach-simple-header-right{display:flex;align-items:flex-start;gap:8px;justify-content:flex-end;background:transparent;border:0;outline:none;box-shadow:none;}
        .coach-simple-header-logo{width:clamp(112px,32vw,164px);max-height:112px;display:flex;align-items:center;justify-content:flex-end;background:transparent;border:0;outline:none;box-shadow:none;}
