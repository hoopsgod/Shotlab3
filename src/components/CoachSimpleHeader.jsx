export default function CoachSimpleHeader({
  ...
  return (
    ...
    >
      <style>{`
        .coach-simple-header-top{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:start;background:transparent;border:0;outline:none;box-shadow:none;}
         .coach-simple-header-right{display:flex;align-items:flex-start;gap:4px;justify-content:flex-end;background:transparent;border:0;outline:none;box-shadow:none;}
        .coach-simple-header-logo{width:clamp(108px,31vw,156px);max-height:102px;display:flex;align-items:flex-start;justify-content:flex-end;background:transparent;border:0;outline:none;box-shadow:none;}
        .coach-simple-header-brand-btn{min-height:32px;max-width:212px;width:max-content;}
