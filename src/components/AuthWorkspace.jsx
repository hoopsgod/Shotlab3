...
<div className="auth-card-enter" style={{background:"rgba(255,255,255,.94)",borderRadius:"30px 30px 30px 12px",padding:"24px 22px",border:"1px solid rgba(255,255,255,.72)",boxShadow:"0 2px 4px rgba(17,26,33,.04),0 30px 80px rgba(7,24,32,.22),inset 0 1px rgba(255,255,255,.88)",WebkitBackdropFilter:"blur(24px) saturate(135%)",backdropFilter:"blur(24px) saturate(135%)"}}>
