  ...
  return (
    <>
      <TeamIdentityTitleStage
        ...
        role="Development"
        title="Progress"
        status={`${trendWord} · ${story.activeDays7}/7 active days`}
        testId="player-progress-team-title"
        iconName="chart"
        className="playerProgressTeamTitle"
        dataLayoutRole="editorial-header"
        dataVisualRole="page-intro"
        dataPageKind="progress"
        dataMobileStage="team-identity"
        ariaLabel="Team development and Progress"
      />
