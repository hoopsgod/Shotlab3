...
export default function PremiumLeaderboardsHub({
  ...
  return <div data-testid={testId} data-viewer-role={viewerRole} data-team-workspace={viewerRole === 'player' ? 'leaderboards' : undefined} aria-label="Leaderboards">
    ...
    <section aria-label="Leaderboard decision metrics" data-testid="leaderboard-metric-surface" data-layout-role="supporting-evidence" data-surface="dark" data-visual-role="supporting-evidence" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,minmax(0,1fr))', gap: 1, margin: '10px 0 8px', overflow: 'hidden', border: '1px solid var(--stroke-1)', borderRadius: 12, backgroundColor: '#121a20', backgroundImage: 'linear-gradient(135deg,#121a20,#0b1014)' }}>
