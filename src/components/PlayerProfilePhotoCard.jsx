...
export default function PlayerProfilePhotoCard({ player = {} }) {
  ...
  return <section data-testid="player-profile-photo-card" style={{display:"flex",gap:12}}>
    <div style={{width:64,height:64,borderRadius:"50%",overflow:"hidden",display:"grid",placeItems:"center"}}>{photo?<img src={photo} alt={name} width={64} height={64} style={{objectFit:"cover"}}/>:name[0]?.toUpperCase()||"P"}</div>
