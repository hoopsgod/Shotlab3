...
export default function CoachDashboardHeaderMobile({ heroRef, userName, teamName, wordmark, onOpenTeamBranding, onLogout }) {
  ...
  return (
    <section ref={heroRef} className="coach-mobile-hero" aria-label="Coach dashboard mobile header">
      <style>{`
        .coach-mobile-hero{position:relative;min-height:322px;overflow:hidden;margin-bottom:8px;padding:14px 14px 10px}
        ...
        .coach-mobile-hero-content{position:relative;z-index:2;max-width:64%}
        ...
        .coach-mobile-brandmark{position:absolute;right:-16px;top:44px;width:min(58vw,236px);z-index:1;opacity:.86;pointer-events:none;filter:drop-shadow(0 22px 36px rgba(0,0,0,.45)) drop-shadow(0 0 22px rgba(200,255,0,.14))}
