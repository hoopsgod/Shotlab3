  ...
  return (
    <section ref={heroRef} className="coach-premium-header" aria-label="Coach dashboard header">
      <style>{`
        ...
        .coach-premium-logo-atmo{position:absolute;right:18px;top:8px;width:min(41%,340px);height:calc(100% - 16px);display:flex;align-items:center;justify-content:flex-end;pointer-events:none;z-index:0}
        .coach-premium-logo-atmo-mark{max-width:100%;max-height:204px;transform:scale(1.06);opacity:.9;filter:drop-shadow(0 16px 30px rgba(0,0,0,0.42)) drop-shadow(0 0 24px rgba(200,255,0,0.18))}
