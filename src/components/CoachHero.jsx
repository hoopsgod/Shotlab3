  ...
  return (
    <section ref={heroRef} className="coach-premium-header" aria-label="Coach dashboard header">
      <style>{`
        ...
        .coach-premium-logo-shell{width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:radial-gradient(circle at 50% 54%,rgba(192,255,0,.10) 0%,rgba(192,255,0,.04) 34%,rgba(0,0,0,0) 72%)}
      ...
      <div className="coach-premium-grid">
        ...
        <div className="coach-premium-logo-zone">
          ...
          <div className="coach-premium-logo-shell">
            <div style={{ maxWidth: "100%", maxHeight: 176, filter: "drop-shadow(0 10px 24px rgba(0,0,0,0.35)) drop-shadow(0 0 22px rgba(200,255,0,0.18))" }}>{wordmark}</div>
          </div>
        </div>
      </div>
    </section>
