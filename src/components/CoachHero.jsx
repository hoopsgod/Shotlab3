...
export default function CoachHero({
  ...
  const mobilePadding = isOverview ? "var(--coach-space-16) var(--coach-space-12)" : "var(--coach-space-12) var(--coach-space-12)";
  const desktopPadding = isOverview ? "var(--coach-space-16) var(--coach-space-16)" : "var(--coach-space-12) var(--coach-space-16)";
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="coach-hero coach-hero-wrap" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--coach-space-12)" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "var(--coach-space-8)", marginTop: "var(--coach-space-8)" }}>
          ...
          <div style={{ marginTop: "var(--coach-space-12)", padding: "var(--coach-space-12)", borderRadius: 14, border: `1px solid ${accentColor ? `${accentColor}55` : "var(--stroke-1)"}`, background: accentColor ? `${accentColor}10` : "rgba(255,255,255,0.04)", width: "fit-content", maxWidth: "min(100%,460px)" }}>
            <TeamIdentity
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "var(--coach-space-8)", alignSelf: "flex-start" }}>
          {avatar}
          {wordmark}
          <button
            type="button"
