  ...
  return (
    <section
      ...
      style={{
        ...
        padding: "6px 0 4px",
        background:
          "linear-gradient(140deg, color-mix(in srgb, var(--accent) 6%, transparent), transparent 46%), radial-gradient(74% 68% at 88% 16%, color-mix(in srgb, var(--accent) 14%, transparent), transparent 72%), radial-gradient(120% 96% at 48% 100%, color-mix(in srgb, var(--surface-2) 55%, transparent), transparent 74%)",
        borderRadius: 14,
      }}
    >
      <style>{`
