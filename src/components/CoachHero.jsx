  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", display: "grid", gap: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "flex-end", gap: 8, flexShrink: 0 }}>
          <div style={{ width: "clamp(118px, 30vw, 160px)", maxHeight: 120, display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
            <div style={{ maxWidth: "100%", maxHeight: 120 }}>
              {wordmark}
            </div>
          </div>
