  ...
  return (
    <section ref={heroRef} className="coach-premium-header" aria-label="Coach dashboard header">
      <style>{`
        ...
        .coach-premium-logo-atmo{position:absolute;right:18px;top:6px;bottom:4px;width:42%;min-width:180px;display:flex;align-items:center;justify-content:flex-end;pointer-events:none;z-index:0;mix-blend-mode:screen}
        .coach-premium-logo-atmo::before{content:"";position:absolute;right:4%;width:86%;height:88%;background:radial-gradient(circle at 45% 50%,rgba(200,255,0,.18) 0%,rgba(130,210,80,.08) 36%,rgba(0,0,0,0) 76%);filter:blur(6px);opacity:.9}
        .coach-premium-logo-atmo::after{content:"";position:absolute;right:7%;top:10%;width:78%;height:62%;background:linear-gradient(132deg,rgba(180,255,0,.00) 0%,rgba(180,255,0,.10) 45%,rgba(180,255,0,.00) 82%);opacity:.38;transform:skewX(-18deg)}
        ...
        @media (max-width:700px){.coach-premium-grid{gap:8px}.coach-premium-name{font-size:clamp(30px,10vw,44px)}.coach-premium-content{padding-right:0}.coach-premium-logo-atmo{width:45%;min-width:118px;top:18px;bottom:auto;height:108px;opacity:.7}.coach-premium-logo-atmo-mark{max-height:112px}}
      `}</style>
