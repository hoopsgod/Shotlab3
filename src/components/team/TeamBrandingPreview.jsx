...
function TeamBrandingPreviewContent() {
  ...
  return <div style={{ display: "grid", gap: 14 }} data-testid="branding-live-preview">
    <div style={{ overflow: "hidden", borderRadius: 20, boxShadow: "0 16px 34px rgba(4,18,25,.18)" }}>
      <TeamIdentityTitleStage variant="hero" surface="dark" role="Coach Mode" title="Mission Control" personName="Coach preview" summary="Program identity and decision authority share one opening system." testId="branding-preview-coach-title" ariaLabel="Coach title stage preview" />
    </div>
    <div style={{ overflow: "hidden", border: "1px solid rgba(24,32,31,.1)", borderRadius: 20, background: "#f8f6ee", padding: "0 16px" }}>
      <TeamIdentityTitleStage variant="standard" surface="light" role="Player" title="Program Training" summary="The same program identity carries into the athlete experience." status="Coach plan active" testId="branding-preview-player-title" ariaLabel="Player title stage preview" />
    </div>
