  ...
  return (
    <section ref={heroRef} className={styles.header}>
      <div className={styles.inner}>
        ...
        <div className={styles.logoSlotSpacer} aria-hidden="true" />
      </div>

      <div className={styles["coach-header-logo-layer"]}>
        <img className={styles["coach-header-logo-img"]} src={logoSrc} alt={`${branding?.teamName || "Team"} logo`} />
      </div>
      <button type="button" onClick={onLogout} aria-label="Log out" className={styles["coach-header-close-btn"]}>✕</button>
    </section>
  );
}
