...
body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandLockup{min-width:0!important;display:flex!important;align-items:center!important;gap:9px!important}
body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy small{color:#748089!important;font-family:var(--font-body)!important;font-size:10px!important;font-weight:760!important;line-height:1.15!important;letter-spacing:.075em!important;text-transform:uppercase!important}
body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy strong{color:#111a21!important;font-family:var(--font-display)!important;font-size:19px!important;font-weight:820!important;line-height:1!important;letter-spacing:-.045em!important;text-transform:none!important}
@media(max-width:700px){
  body.mission-control-active [data-mobile-visual-system="phase-2"].mcShellV3{background:linear-gradient(180deg,#e8ebe2 0,#f3f1ea 49%,#f7f6f1 100%)!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .missionControl{padding:10px 12px 108px!important;gap:14px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeader{position:relative!important;z-index:4!important;grid-template-columns:40px minmax(0,1fr) auto!important;gap:8px!important;margin:0 8px -78px!important;padding:max(8px,env(safe-area-inset-top)) 4px 8px!important;border:0!important;border-radius:20px!important;background:transparent!important;box-shadow:none!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy small{color:#91a2aa!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy strong{color:#f7fafb!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcMobileMenu{width:40px!important;height:40px!important;margin:0!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:14px!important;background:rgba(255,255,255,.07)!important;color:#f4f8f9!important;box-shadow:inset 0 1px rgba(255,255,255,.08)!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeaderTeamMark{width:42px!important;height:42px!important;flex-basis:42px!important;border-radius:13px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeaderTeamMark img{width:44px!important;height:44px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy strong{display:block!important;max-width:30vw!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeaderActions{display:flex!important;align-items:center!important;min-width:0!important;gap:5px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcTeamSelect{display:inline-flex!important;min-width:0!important;max-width:min(82px,22vw)!important;min-height:40px!important;padding-inline:9px!important;border-color:rgba(255,255,255,.12)!important;border-radius:13px!important;background:rgba(255,255,255,.07)!important;color:#e7eef1!important;font-size:10px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBell{width:40px!important;height:40px!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:13px!important;background:rgba(255,255,255,.07)!important;color:#f4f8f9!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHero{position:relative!important;z-index:1!important;min-height:426px!important;max-height:none!important;overflow:hidden!important;border:1px solid rgba(200,255,26,.16)!important;border-radius:34px 34px 34px 12px!important;background:radial-gradient(circle at 88% 8%,rgba(200,255,26,.18),transparent 31%),radial-gradient(circle at 5% 100%,rgba(64,116,137,.24),transparent 44%),linear-gradient(145deg,#0b2a38 0,#06151c 78%)!important;box-shadow:0 32px 70px rgba(7,24,32,.28),inset 0 1px rgba(255,255,255,.08)!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeroContent{grid-template-columns:minmax(0,1fr) 68px!important;padding:106px 20px 20px!important;gap:9px 12px!important;background:transparent!important;background-color:transparent!important;background-image:none!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeroTeamMark{top:102px!important;right:18px!important;width:70px!important;height:70px!important;border:0!important;border-radius:0!important;background:transparent!important;background-color:transparent!important;box-shadow:none!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeroTeamMark img{width:66px!important;height:66px!important;filter:drop-shadow(0 16px 24px rgba(0,0,0,.28))!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcDecisionIndex{position:absolute!important;right:18px!important;bottom:82px!important;color:rgba(255,255,255,.07)!important;font-family:var(--font-display)!important;font-size:92px!important;font-weight:880!important;line-height:.8!important;letter-spacing:-.08em!important;pointer-events:none!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcEyebrow{color:#c8ff1a!important;font-size:10px!important;letter-spacing:.11em!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHero h1{max-width:9.2ch!important;margin-top:10px!important;color:#f7fafb!important;font-size:clamp(39px,10.8vw,46px)!important;font-weight:850!important;line-height:.9!important;letter-spacing:-.064em!important;text-wrap:balance!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeroContent>p{max-width:28ch!important;margin-top:10px!important;color:#b7c5cb!important;font-size:14px!important;line-height:1.46!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcCourtArtwork{opacity:.5!important;filter:saturate(.8)!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcRealityStrip{margin-top:15px!important;overflow:hidden!important;border:1px solid rgba(255,255,255,.10)!important;border-radius:20px 20px 20px 8px!important;background:rgba(255,255,255,.055)!important;-webkit-backdrop-filter:blur(16px)!important;backdrop-filter:blur(16px)!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcRealityStrip>button{min-height:52px!important;padding:6px 4px!important;border-color:rgba(255,255,255,.09)!important;background:transparent!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcRealityStrip strong{color:#f7fafb!important;font-size:21px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcRealityStrip small{color:#9fb0b7!important;font-size:10px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcPrimary{min-height:56px!important;margin-top:13px!important;border:0!important;border-radius:18px 18px 18px 7px!important;background:linear-gradient(135deg,#c8ff1a,#aee800)!important;color:#071007!important;box-shadow:0 14px 30px rgba(174,232,0,.18),inset 0 1px rgba(255,255,255,.36)!important;font-size:14px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcFocusGrid{gap:14px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcSection{border:1px solid rgba(17,26,33,.08)!important;border-radius:26px 26px 26px 10px!important;background:rgba(255,255,255,.76)!important;box-shadow:0 18px 44px rgba(17,26,33,.08),inset 0 1px rgba(255,255,255,.86)!important}
}
@media(max-width:390px){
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcTeamSelect{width:58px!important;max-width:58px!important;font-size:0!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcTeamSelect:before{content:"Team";font-size:10px!important;font-weight:740!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcTeamSelect>span{font-size:10px!important}
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcBrandCopy strong{max-width:28vw!important;font-size:18px!important}
}
@media(max-width:700px) and (prefers-reduced-transparency:reduce){
  body.mission-control-active [data-mobile-visual-system="phase-2"] .mcHeader{background:transparent!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important}
}`;
...
export default function CoachCommandCenter({
  ...
  return <>
    ...
    <div className={`mcShell mcShellV3 ${onboardingMode ? "is-onboarding" : "has-team-data"}`} data-testid="coach-command-center-full" data-home-hierarchy="decision-first" data-mobile-product-reset="phase-1" data-mobile-visual-system="phase-2" data-phase2-composition="integrated-command-deck" style={{ "--mc": accent, "--mc-secondary": secondary }}>
      ...
      <main className="missionControl">
        ...
        <section className={`mcHero is-${primaryCommand.state}`} data-testid="coach-primary-objective" data-home-role="primary">
          ...
          <span className="mcDecisionIndex" aria-hidden="true">01</span>
