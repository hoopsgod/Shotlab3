...
const _BUTTON_SYSTEM_CSS=`:root{--lime:var(--accent);--btn-height:48px;--btn-height-dense:44px;--btn-radius:12px;--btn-pad-x:20px;--btn-primary-bg:var(--lime);--btn-primary-fg:#0B0F0C;--btn-secondary-bg:rgba(255,255,255,0.04);--btn-secondary-border:rgba(255,255,255,0.14);--btn-secondary-fg:#EAEAEA;}
