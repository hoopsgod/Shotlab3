...
.pageHeader{margin:0 0 var(--space-6);padding:var(--space-4) var(--space-4) var(--space-3);border-radius:16px;border:1px solid rgba(184,255,0,.2);background:linear-gradient(135deg,var(--pageAccentBg),rgba(10,10,10,.96) 58%);box-shadow:0 10px 26px rgba(0,0,0,.34);}
.pageHeaderTop{display:flex;align-items:center;gap:var(--space-3);flex-wrap:wrap;}
.pageHeaderBadge{width:48px;height:48px;border-radius:14px;border:1px solid rgba(184,255,0,.36);background:rgba(184,255,0,.1);display:flex;align-items:center;justify-content:center;color:var(--headerAccent);box-shadow:0 6px 14px rgba(0,0,0,.28), 0 0 0 1px rgba(184,255,0,.1) inset;flex-shrink:0;}
...
.pageAccentBar{height:3px;width:44%;border-radius:999px;background:var(--headerAccent);box-shadow:none;opacity:.9;margin-top:var(--space-3);}
...
.feedListItem::before{content:'';position:absolute;left:0;top:17px;width:6px;height:6px;border-radius:50%;background:var(--pageAccent);box-shadow:0 0 0 1px color-mix(in srgb, var(--pageAccent) 35%, transparent);}
