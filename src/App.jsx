...
function CoachPlayerDevelopmentProfile({player,programDrills=[],programScores=[],shotLogs=[],rsvps=[],events=[],scRsvps=[],scLogs=[],teamId=""}){
const profile=buildCoachPlayerDevelopmentProfile({player,programDrills,programScores,shotLogs,rsvps,events,scRsvps,scLogs,teamId});
