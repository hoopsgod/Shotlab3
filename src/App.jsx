  ...
  {tab==="home"&&!active&&<div className={slideClass} key="home">
    ...
    {(()=>{
      ...
      const playerChecklist=[
        ...
        {label:"View upcoming event",done:hasUpcomingEvents,onClick:()=>switchTab("duels"),ariaLabel:"View upcoming events in Program"},
        {label:"RSVP to an event",done:hasRsvped,onClick:()=>switchTab("duels"),ariaLabel:"Go to Program events to RSVP"},
