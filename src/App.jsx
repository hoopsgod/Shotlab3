...
PRIMARY:"#C8FF1A",
PRIMARY_DIM:"#9CA3AF",
PRIMARY_GLOW:"rgba(200, 255, 26, 0.1)",
SECONDARY:"#9CA3AF",
...
const PAGE_ACCENTS={
feed:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(140,156,120,0.05)"},
drills:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(140,156,120,0.05)"},
events:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(140,156,120,0.05)"},
sc:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(140,156,120,0.05)"},
players:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(140,156,120,0.05)"},
};
const MODE_CARD_TOKENS={
BASE_BG:"var(--surface-1)",
BASE_BORDER:"var(--border-1)",
BASE_SHADOW:"var(--shadow-1)",
HOME_TINT:"rgba(140, 156, 120, 0.08)",
PROGRAM_TINT:"rgba(0, 176, 255, 0.12)",
HOME_GLOW:"rgba(184,255,0,.08)",
PROGRAM_GLOW:"rgba(184,255,0,.08)",
...
.feedListItem::before{content:'';position:absolute;left:0;top:17px;width:6px;height:6px;border-radius:50%;background:var(--pageAccent);box-shadow:0 0 4px var(--pageAccentGlow);}
