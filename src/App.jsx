...
const PAGE_ACCENTS={
feed:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(156,177,64,0.06)"},
drills:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(156,177,64,0.06)"},
events:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(156,177,64,0.06)"},
sc:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(156,177,64,0.06)"},
players:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(156,177,64,0.06)"},
};
...
.pageHeaderPillBrand{border:1px solid transparent;background:var(--page-accent,var(--color-primary,#C8FF00));color:#11161F;box-shadow:0 4px 16px rgba(184,255,0,.22);}
...
:root{
  ...
  --text-1:rgba(236,240,247,.92);
  --text-2:rgba(200,210,223,.82);
  --text-3:rgba(154,167,184,.78);
...
<div style={{position:"absolute",inset:0,background:"radial-gradient(ellipse at top left, rgba(77, 213, 229, 0.03) 0%, transparent 70%)",pointerEvents:"none"}}/>
...
function BrandBackdrop(){return <><div style={{position:"fixed",inset:0,background:"radial-gradient(ellipse 80% 40% at 50% 0%, rgba(77, 213, 229, 0.022) 0%, transparent 100%)",pointerEvents:"none",zIndex:0}}/><div style={{position:"fixed",left:"50%",top:"50%",transform:"translate(-50%,-35%)",opacity:.03,pointerEvents:"none",zIndex:0,width:180}}><SLLogo size={180}/></div></>}
