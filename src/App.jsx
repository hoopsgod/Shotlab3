...
.pageSignature{position:relative;overflow:hidden;margin:0 0 14px;padding:14px 14px 10px;border-radius:16px;border:1px solid color-mix(in srgb,var(--page-accent) 30%, transparent);background:linear-gradient(180deg,var(--page-accent-soft),rgba(10,10,10,0) 46%),rgba(11,11,11,.95);box-shadow:0 8px 24px rgba(0,0,0,.3);}
.pageSignatureTop{display:flex;align-items:center;gap:12px;}
.pageSignatureBadge{width:48px;height:48px;border-radius:14px;border:1px solid color-mix(in srgb,var(--signatureAccent) 62%, transparent);background:linear-gradient(145deg,rgba(23,23,23,.95),rgba(12,12,12,.95));display:flex;align-items:center;justify-content:center;color:var(--signatureAccent);box-shadow:0 0 14px color-mix(in srgb,var(--signatureAccent) 28%, transparent),inset 0 1px 0 rgba(255,255,255,.08);flex-shrink:0;}
.pageSignatureText h1{font-family:${FD};font-size:26px;letter-spacing:.12em;color:#fff;line-height:1;}
.pageSignatureText p{font-family:${FB};font-size:11px;color:rgba(255,255,255,.68);margin-top:4px;letter-spacing:.02em;}
.pageSignatureRight{margin-left:auto;}
...
.pageSignatureBar{height:3px;width:50%;border-radius:999px;background:var(--signatureAccent);box-shadow:0 0 12px color-mix(in srgb,var(--signatureAccent) 55%, transparent);margin-top:12px;}
...
@media(min-width:768px){.pageSignatureBadge{width:56px;height:56px;}.drillsMetrics{grid-template-columns:repeat(2,minmax(0,1fr));}}
`;
...
<div style={{flex:1,padding:`${showMiniHeader?"88px":"16px"} 20px 110px`,overflowY:"auto",position:"relative",zIndex:1}}>
  {/* FEED */}
  {tab==="feed"&&<div className="page pageShell page-feed fade-up" data-accent="feed" style={shellVars("feed")}><PageSignature title="FEED" subtitle="Today’s activity, streaks, and follow-ups" accent={PAGE_ACCENTS.feed.accent} icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7" rx="2"/><rect x="14" y="3" width="7" height="7" rx="2"/><rect x="3" y="14" width="7" height="7" rx="2"/><rect x="14" y="14" width="7" height="7" rx="2"/></svg>} /><div className="heroModule"><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:10}}><div><div style={{fontFamily:FD,color:PAGE_ACCENTS.feed.accent,fontSize:12,letterSpacing:2}}>TODAY'S PULSE</div><div style={{fontFamily:FB,color:MUTED,fontSize:10}}>Who's active, streaking, and needs attention</div></div><button className="pageHeaderPill" onClick={()=>setTab("players")}>View Team</button></div>
  ...
  {tab==="drills"&&editD&&<div className="page pageShell scale-in" data-accent="drills" style={{...shellVars("drills"),paddingTop:8}}><PageSignature title="DRILLS" subtitle="Assign, start, and manage skill work" accent={PAGE_ACCENTS.drills.accent} icon={<DrillIcon type="ft" size={22} color={PAGE_ACCENTS.drills.accent}/>} rightAction={<button className="pageHeaderPill" onClick={()=>setEditD(null)}>Manage</button>} />
