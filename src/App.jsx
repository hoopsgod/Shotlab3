...
.pageHeaderPill{padding:6px 10px;border-radius:999px;border:1px solid color-mix(in srgb,var(--pageAccent) 50%, transparent);background:color-mix(in srgb,var(--pageAccent) 14%, #1A1A1A);font-family:${FB};font-size:calc(10px * var(--text-scale-label,1));color:var(--pageAccent);font-weight:700;letter-spacing:var(--tracking-tight);text-transform:uppercase;transition:background .15s ease,box-shadow .15s ease,border-color .15s ease,transform .1s ease;}
...
.heroStatLbl{font-family:${FB};font-size:calc(9px * var(--text-scale-label,1));color:var(--text-tertiary);letter-spacing:var(--tracking-tight);margin-top:2px;}
...
.eventsDatePill{display:inline-flex;align-items:center;justify-content:center;min-width:56px;padding:6px 8px;border-radius:999px;background:rgba(255,196,0,.16);border:1px solid rgba(255,196,0,.45);color:#FFC400;font-size:calc(10px * var(--text-scale-label,1));font-family:${FB};font-weight:700;letter-spacing:.08em;}
