...
.premiumStatGrid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(0,1fr);gap:12px;margin-top:18px;position:relative;z-index:1;align-items:stretch;}
...
.premiumPrimaryMetric{padding:16px 14px;border-radius:16px;background:linear-gradient(165deg,color-mix(in srgb,var(--pageAccent) 12%, #192231),#121a27 62%,#101722);display:flex;flex-direction:column;justify-content:space-between;min-height:112px;}
.premiumMetricKicker{font-family:${FB};font-size:10px;color:var(--text-2);letter-spacing:.08em;text-transform:uppercase;}
.premiumSecondaryMetrics{display:grid;gap:10px;}
.premiumSecondaryMetric{padding:12px;border-radius:12px;background:linear-gradient(180deg,#161d29,#141b27);}
...
@media(max-width:767px){.premiumStatGrid{grid-template-columns:1fr;}.premiumSummaryActions .pageHeaderPill{flex:1;justify-content:center;}}
