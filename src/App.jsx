...
{allRows.length===0&&<EmptyState preset="noDuels" onCtaClick={()=>setActiveFilter("all")}/>}
...
{isDesktop&&<aside className="insights-panel"><div className="panel-title">COACH INSIGHTS</div><EmptyState preset="noCoachInsightsYet" ctaLabel="View feed" onCtaClick={()=>setTab("feed")}/></aside>}
  </div>;
}
...
{roster.length===0&&<EmptyState preset="noPlayers" ctaLabel="Add roster player" onCtaClick={()=>setShowAdd(true)}/>}
