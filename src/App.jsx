...
if(isPendingConfirmation(authRes.data))return{ok:true,pendingConfirmation:true,message:"Account created. Check your email to confirm your account, then log in."};
