...
if(!result?.ok){setMessage(result?.error||"Could not complete that request. Please try again or contact support.");setBusy(false);return;}
setMessage("Account request complete. You have been signed out safely.");
};
return <div data-testid="account-data-request-entry" style={{marginTop:32,paddingTop:24,borderTop:`1px solid ${BORDER_CLR}44`}}>
  ...
  :<div className="fade-up" style={{background:"#FF454508",borderRadius:16,padding:"18px",border:`1px solid #FF454533`}}>
    ...
    <a href={deleteHref} style={{display:"inline-flex",alignItems:"center",minHeight:36,color:VOLT,fontFamily:FB,fontSize:11,fontWeight:800,textDecoration:"none",marginBottom:12}}>Email support instead</a>
    ...
    <div style={{display:"flex",gap:8}}>
      ...
      <button onClick={runDelete} disabled={busy} className="btn-v cta-danger" style={{opacity:busy?0.65:1}}>{busy?"WORKING...":"CONFIRM"}</button>
    </div>
  </div>}
