...
<PlayerDashboardHeader
  ...
  wordmark={<BrandWordmark size={20} small/>}
  onOpenProfile={()=>switchTab("profile")}
  profileInitial={(u.name||"?")[0].toUpperCase()}
  actions={<>
    <button aria-label="Open profile" onClick={()=>switchTab("profile")}>
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21a8 8 0 0 0-16 0"/><circle cx="12" cy="7" r="4"/></svg>
    </button>
