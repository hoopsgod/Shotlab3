...
if(authRes.data?.access_token)window.localStorage?.setItem("sl:supabase-access-token",authRes.data.access_token);
...
if(!p)return{ok:false,err:"Profile not found. Contact your coach."};
