...
<div className="player-quick-actions" aria-label="Player quick actions" style={{display:"flex",gap:8,justifyContent:"flex-end",alignItems:"center",padding:"8px 20px 0",position:"relative",zIndex:2}}>
  <button type="button" aria-label="Open profile" onClick={()=>switchTab("profile")} style={{minHeight:38,padding:"0 12px",borderRadius:10,border:`1px solid ${BORDER_CLR}`,background:CARD_BG,color:LIGHT,fontFamily:FB,fontSize:11,fontWeight:700,letterSpacing:"0.06em",textTransform:"uppercase",cursor:"pointer"}}>Profile</button>
  <button type="button" aria-label="Log out" onClick={logout} style={{minHeight:38,padding:"0 12px",borderRadius:10,border:`1px solid ${BORDER_CLR}`,background:CARD_BG,color:LIGHT,fontFamily:FB,fontSize:11,fontWeight:700,letterSpacing:"0.06em",textTransform:"uppercase",cursor:"pointer"}}>Logout</button>
</div>
