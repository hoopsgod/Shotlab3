...
const logoHeight=Math.max(38,Math.round(size*(small?2.65:2.15)));
if(branding?.logoUrl){
  return <div style={{display:"flex",alignItems:"center",justifyContent:"center",minWidth:0,maxWidth:"100%",width:"100%"}}>
    <img src={branding.logoUrl} alt={`${branding?.teamName||"Team"} logo`} style={{height:logoHeight,maxHeight:"92%",maxWidth:"118%",objectFit:"contain"}}/>
  </div>;
}
