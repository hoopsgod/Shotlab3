...
const scopedChallenges=filterActiveTeamChallengeRows(challenges.filter(c=>c.teamId===user?.teamId),appActiveTeamPlayerIdentity.emailSet);
...
rows:filterActiveTeamLeaderboardRows(homeShotsLeaderboard?.rows||[],appActiveTeamPlayerIdentity.emailSet,appActiveTeamPlayerIdentity.nameSet),
}),[homeShotsLeaderboard,appActiveTeamPlayerIdentity.emailSet,appActiveTeamPlayerIdentity.nameSet]);
