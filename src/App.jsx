...
{h:"Support fallback",p:"If you cannot sign in, email support@shotlab.app from the account email and include 'Delete my ShotLab account' in the subject."},
...
return <div data-testid="account-data-request-entry" style={{marginTop:32,paddingTop:24,borderTop:`1px solid ${BORDER_CLR}44`}}>
  ...
  :<div className="fade-up" style={{background:"#FF454508",borderRadius:16,padding:"18px",border:`1px solid #FF454533`}}>
    ...
    <div style={{display:"flex",gap:8}}>
      ...
      <button onClick={runDelete} disabled={busy} className="btn-v cta-danger" style={{opacity:busy?0.65:1}}>{busy?"WORKING...":"CONFIRM DELETE ACCOUNT"}</button>
    </div>
