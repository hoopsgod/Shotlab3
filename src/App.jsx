...
import { isDemoAccount, isDemoMode } from "./lib/demoMode.js";
...
const demoSavedLog={...localLog,syncState:"local_pending",syncSource:"local",syncError:"",syncDiagnostic:null};
...
const syncIssueShots=useMemo(()=>isDemoHomeShotSession?[]:shotLogs.filter(s=>s.email===u.email&&(s.syncState==="failed_sync")),[isDemoHomeShotSession,shotLogs,u.email]);
...
if(isDemoSession||!syncIssueShots.length)return null;
...
const isDemoHomeShotSession=isDemoMode()||isDemoAccount(u);
const syncIssueShots=useMemo(()=>isDemoHomeShotSession?[]:my.filter(s=>s.syncState==="failed_sync"),[isDemoHomeShotSession,my]);
const today=todayStr();
