...
const FD="'Inter','Segoe UI','Helvetica Neue',Arial,sans-serif",FB="'Inter','Segoe UI','Helvetica Neue',Arial,sans-serif";
const PAGE_ACCENTS={
...
.shared-card--primary{border-color:rgba(91,243,255,.24)!important;background:linear-gradient(180deg,rgba(91,243,255,.085),rgba(91,243,255,0)),var(--surface-2)!important;}
...
.fieldLabel{text-transform:none;letter-spacing:.08em;font-size:.74rem;}
...
.pageHeaderText p{font-family:${FB};font-size:11px;color:var(--text-secondary);margin-top:4px;text-transform:none;letter-spacing:var(--tracking-tight);}
.pageHeaderRight{margin-left:auto;flex-shrink:0;}
.pageHeaderPill{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:0 16px;border-radius:12px;border:1px solid rgba(255,255,255,0.22);background:transparent;font-family:${FB};font-size:10px;color:var(--text-2);font-weight:700;letter-spacing:var(--tracking-tight);text-transform:none;transition:background .15s ease,border-color .15s ease,transform .1s ease,filter .15s ease;opacity:.9;}
...
`;
const _DESKTOP_SHELL_CSS=`:root{--shell-bg:#070707;--panel-bg:rgba(255,255,255,0.04);--panel-border:rgba(255,255,255,0.08);--text-dim:rgba(255,255,255,0.72);}.app-shell{min-height:100vh;background:var(--shell-bg);}@media (min-width:1024px){.app-shell.is-desktop{display:grid;grid-template-columns:240px minmax(640px,1fr) 320px;gap:var(--stack-gap);padding:var(--stack-gap);align-items:start;}.sidebar-nav{position:sticky;top:18px;height:calc(100vh - 36px);background:var(--surface-1);border:1px solid var(--stroke-1);border-radius:var(--radius-card);box-shadow:var(--shadow-0);padding:var(--mini-card-pad);overflow:auto;}.sidebar-nav .nav-title{font-size:12px;letter-spacing:0.26em;text-transform:none;color:var(--text-dim);margin:6px 10px 14px;}.sidebar-nav .nav-item{display:flex;align-items:center;gap:10px;padding:12px 12px;border-radius:14px;color:rgba(255,255,255,0.70);cursor:pointer;user-select:none;border:1px solid transparent;transition:background 140ms ease,border-color 140ms ease,transform 120ms ease;width:100%;background:transparent;text-align:left;}.sidebar-nav .nav-item:hover{background:rgba(255,255,255,0.05);transform:translateY(-1px);}.sidebar-nav .nav-item.is-active{background:rgba(198,255,0,0.10);border-color:rgba(198,255,0,0.22);color:#C6FF00;}.shell-main{min-width:0;}.content-wrap{background:var(--surface-1);border:1px solid var(--stroke-1);border-radius:var(--radius-card);box-shadow:var(--shadow-0);padding:var(--card-pad);}.insights-panel{position:sticky;top:18px;height:calc(100vh - 36px);background:var(--surface-1);border:1px solid var(--stroke-1);border-radius:var(--radius-card);box-shadow:var(--shadow-0);padding:var(--mini-card-pad);overflow:auto;}.insights-panel .panel-title{font-size:12px;letter-spacing:0.26em;text-transform:none;color:var(--text-dim);margin:6px 10px 14px;}.insights-panel .placeholder{background:rgba(0,0,0,0.35);border:1px dashed rgba(255,255,255,0.24);border-radius:14px;padding:14px;color:rgba(255,255,255,0.7);font-size:13px;line-height:1.35;}}`;
...
.listRowMeta{color:var(--text-meta);font-size:12px;line-height:1.2;letter-spacing:0.01em;text-transform:none;}
...
.listRowStatSub{color:var(--text-muted);font-size:11px;line-height:1.1;letter-spacing:0.10em;text-transform:none;}
.listRowStatus{font-size:12px;line-height:1.2;letter-spacing:0.01em;font-weight:700;}
...
.btn-link{min-height:40px;height:40px;padding:0 12px;background:transparent;border:none;border-radius:var(--btn-radius);color:var(--text-2);font-size:13px;letter-spacing:0.01em;font-weight:700;text-transform:none;opacity:.92;}
...
.cta-primary,.cta-primary-accent,.cta-brand,.cta-danger{background:var(--btn-primary-bg)!important;color:var(--btn-primary-fg)!important;border:none!important;border-radius:var(--btn-radius)!important;letter-spacing:0.01em!important;font-weight:700!important;box-shadow:none!important;min-height:var(--btn-height)!important;height:var(--btn-height)!important;padding:0 var(--btn-pad-x)!important;}
...
.cta-secondary{background:transparent!important;border:1px solid rgba(255,255,255,0.22)!important;color:var(--text-2)!important;border-radius:var(--btn-radius)!important;letter-spacing:0.01em!important;opacity:.9;}
.cta-secondary-link{background:transparent;border:none;color:var(--text-2);font-size:13px;letter-spacing:0.01em;font-weight:700;text-transform:none;min-height:40px;padding:0 12px;border-radius:var(--btn-radius);opacity:.92;}
