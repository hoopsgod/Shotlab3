...
const activeTeamPlayerEmails=useMemo(()=>getActiveTeamPlayerEmails(players,u?.teamId),[players,u?.teamId]);
const activeTeamPlayerNames=useMemo(()=>getActiveTeamPlayerNames(players,u?.teamId),[players,u?.teamId]);
const activeTeamPlayerEmailSet=useMemo(()=>new Set(activeTeamPlayerEmails),[activeTeamPlayerEmails]);
const activeTeamPlayerNameSet=useMemo(()=>new Set(activeTeamPlayerNames),[activeTeamPlayerNames]);
