...
// TODO(App Store): replace these with final monitored ShotLab inboxes before App Store submission.
const SUPPORT_EMAIL="support@shotlab.app";
const PRIVACY_EMAIL="privacy@shotlab.app";
const LEGAL_ROUTES={
  "/privacy":{
