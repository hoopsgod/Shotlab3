...
<div style={{position:"relative",zIndex:1,padding:"max(20px,env(safe-area-inset-top)) 20px 0"}}>
  ...
  />
  <div aria-label="Player quick actions" style={{display:"flex",justifyContent:"flex-end",gap:8,margin:"6px 0 0"}}>
    <button type="button" onClick={()=>switchTab("profile")} style={{minHeight:30,borderRadius:999,border:"1px solid var(--stroke-1)",background:"rgba(255,255,255,0.025)",color:"var(--text-2)",fontFamily:FB,fontSize:10,fontWeight:700,letterSpacing:"0.06em",textTransform:"uppercase",padding:"0 10px",cursor:"pointer"}}>Profile</button>
    <button type="button" aria-label="Toggle theme" onClick={()=>setTheme(t=>t==="dark"?"light":"dark")} style={{minHeight:30,borderRadius:999,border:"1px solid var(--stroke-1)",background:"rgba(255,255,255,0.025)",color:"var(--text-2)",fontFamily:FB,fontSize:10,fontWeight:700,letterSpacing:"0.06em",textTransform:"uppercase",padding:"0 10px",cursor:"pointer"}}>Theme</button>
    <button type="button" aria-label="Log out" onClick={logout} style={{minHeight:30,borderRadius:999,border:"1px solid var(--stroke-1)",background:"rgba(255,255,255,0.025)",color:"var(--text-2)",fontFamily:FB,fontSize:10,fontWeight:700,letterSpacing:"0.06em",textTransform:"uppercase",padding:"0 10px",cursor:"pointer"}}>Logout</button>
  </div>
</div>
