      ...
      return <>
        ...
        <section className="accent-card" style={{borderRadius:16,padding:isDesktop?"14px":"12px",marginBottom:12,background:"linear-gradient(152deg, rgba(255,255,255,0.05), rgba(255,255,255,0.015))",border:"1px solid rgba(255,255,255,0.16)"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:10,marginTop:10,flexWrap:"wrap"}}>
            ...
            <button className="btn-v cta-primary" type="button" onClick={handleSaveCoachPriorities} disabled={coachPrioritiesSaving||!coachPrioritiesDirty} style={{minWidth:220,padding:"12px 18px",fontSize:12,letterSpacing:"0.06em",opacity:coachPrioritiesSaving||!coachPrioritiesDirty?0.72:1,boxShadow:"0 10px 26px rgba(200,255,0,0.24)",border:"1px solid rgba(200,255,0,0.56)"}}>{coachPrioritiesSaving?"SAVING...":"SAVE PRIORITIES"}</button>
          </div>
        </section>
