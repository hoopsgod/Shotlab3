...
<div ref={playerScrollRef} style={{flex:1,padding:isDesktop?"14px 20px 36px":"16px 20px 124px",overflowY:"auto",overflowX:"hidden",position:"relative",zIndex:1,transform:`translateY(${pullY}px)`,transition:pullY?"none":"transform .3s",width:"100%",maxWidth:isDesktop?"none":760,margin:"0 auto"}} onTouchStart={isDesktop?undefined:onTS} onTouchMove={isDesktop?undefined:onTM} onTouchEnd={isDesktop?undefined:onTE}>
  ...
  {tab==="leaderboards"&&!active&&<div className={slideClass} key="leaderboards">
    <section style={{padding:"16px",borderRadius:16,border:"1px solid rgba(200,255,0,0.34)",background:"linear-gradient(158deg, rgba(200,255,0,0.16), rgba(255,255,255,0.02) 42%, rgba(8,10,14,0.88))",boxShadow:"0 14px 34px rgba(0,0,0,0.3)",marginBottom:12}}>
      <div style={{fontFamily:FB,color:VOLT,fontSize:10,letterSpacing:"0.12em",fontWeight:900}}>COMPETITION HUB</div>
      <div style={{fontFamily:FD,color:LIGHT,fontSize:26,letterSpacing:"0.05em",marginTop:5}}>LEADERBOARDS</div>
      ...
      <div style={{display:"flex",gap:6,flexWrap:"wrap",marginTop:9}}>{["At-Home Shots","Events Attended","Strength & Conditioning","Coach Custom Drills"].map(label=><span key={label} style={{fontFamily:FB,fontSize:10,color:LIGHT,padding:"4px 8px",borderRadius:999,border:"1px solid rgba(255,255,255,0.18)",background:"rgba(255,255,255,0.03)"}}>{label}</span>)}</div>
    </section>
    ...
    <section style={{marginTop:10,padding:"12px",borderRadius:12,border:"1px solid var(--stroke-1)",background:"var(--surface-2)"}}><div style={{fontFamily:FD,color:LIGHT,fontSize:15}}>Events Attended</div><div style={{fontFamily:FB,color:T.SUB,fontSize:12,marginTop:4}}>Event attendance leaderboards will appear after players check into events.</div></section>
    <section style={{marginTop:10,padding:"12px",borderRadius:12,border:"1px solid var(--stroke-1)",background:"var(--surface-2)"}}><div style={{fontFamily:FD,color:LIGHT,fontSize:15}}>Strength & Conditioning</div><div style={{fontFamily:FB,color:T.SUB,fontSize:12,marginTop:4}}>Strength leaders will appear after players complete assigned S&C work.</div></section>
    <section style={{marginTop:10,padding:"12px",borderRadius:12,border:"1px solid var(--stroke-1)",background:"var(--surface-2)"}}><div style={{fontFamily:FD,color:LIGHT,fontSize:15}}>Coach Drills</div><div style={{fontFamily:FB,color:T.SUB,fontSize:12,marginTop:4}}>Drill leaders will appear after players log coach-assigned drills.</div></section>
  </div>}
