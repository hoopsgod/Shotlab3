...
const PAGE_ACCENTS={
feed:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(99,210,255,0.08)"},
drills:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(99,210,255,0.08)"},
events:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(99,210,255,0.08)"},
sc:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(99,210,255,0.08)"},
players:{accent:"var(--accent)",glow:"var(--accent-soft)",bg:"rgba(99,210,255,0.08)"},
};
const MODE_CARD_TOKENS={
BASE_BG:"var(--surface-1)",
BASE_BORDER:"var(--border-1)",
BASE_SHADOW:"var(--shadow-1)",
HOME_TINT:"rgba(99, 210, 255, 0.08)",
PROGRAM_TINT:"rgba(99, 210, 255, 0.12)",
HOME_GLOW:"rgba(99,210,255,.06)",
PROGRAM_GLOW:"rgba(99,210,255,.10)",
...
const TIERS=[{min:0,name:"ROOKIE",color:"#555",bg:"#55555515"},{min:2,name:"IRON",color:"#A0A0A0",bg:"#A0A0A015"},{min:3,name:"BRONZE",color:"#A0A0A0",bg:"#A0A0A015"},{min:5,name:"SILVER",color:"#A0A0A0",bg:"#A0A0A015"},{min:8,name:"GOLD",color:"#63D2FF",bg:"#63D2FF15"},{min:12,name:"DIAMOND",color:CYAN,bg:CYAN+"15"}];
...
const STREAK_BADGES=[{days:7,name:"WEEK WARRIOR",icon:"7",color:"#A0A0A0"},{days:14,name:"TWO-WEEK GRIND",icon:"14",color:"#A0A0A0"},{days:30,name:"MONTHLY BEAST",icon:"30",color:"#63D2FF"},{days:60,name:"IRON WILL",icon:"60",color:CYAN},{days:100,name:"CENTURION",icon:"💯",color:VOLT}];
...
const getDrillAccentColor=name=>DRILL_ACCENTS[name]||"#63D2FF";
...
.pageHeaderPillBrand{border:1px solid transparent;background:var(--page-accent,var(--color-primary,#63D2FF));color:#0B0D10;box-shadow:0 4px 16px rgba(99,210,255,.24);}
.pageHeaderPillBrand:hover{text-decoration:none;filter:brightness(1.03);}
.pageHeaderPillBrand:focus-visible{outline-color:#63D2FF;}
...
.lbRow--leader{border-color:rgba(184,255,0,.26)!important;box-shadow:0 10px 24px rgba(0,0,0,.42),0 0 0 1px rgba(99,210,255,.18) inset!important;}
...
{resolved.map(ch=>{
  ...
  const resultColor=isPending?MUTED:won?VOLT:tied?"#63D2FF":"#FF4545";
  ...
  return <ListItem key={ch.id+"-"+ch.ts} className="listRow" style={{background:CARD_BG,border:isPending?`1px solid ${ORANGE}22`:undefined,padding:`${spacing.md}px ${spacing.md}px`}}>
    ...
    <div style={{width:40,height:40,borderRadius:12,background:resultColor+"12",border:`1px solid ${resultColor}33`,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
      ...
      :tied?<span style={{fontFamily:FD,color:"#63D2FF",fontSize:14}}>=</span>
...
<div className="card" style={{marginBottom:16,minHeight:100,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"16px"}}>
  <div style={{fontFamily:FD,color:"#63D2FF",fontSize:48,fontWeight:900,lineHeight:1}}>{myScLogs.length}</div>
...
<div className="uiDecor" aria-hidden="true" style={{width:42,height:42,borderRadius:12,background:"rgba(99,210,255,.10)",border:"1px solid rgba(99,210,255,.24)",display:"flex",alignItems:"center",justifyContent:"center"}}>
  ...
  <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",position:"relative",gap:14}}>
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",gap:10,marginTop:8}}>
        <svg className={rankFx?"rank-badge-flash":""} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#63D2FF" strokeWidth="2"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/></svg>
...
{drillStats.map(d=>{const accentColor=getDrillAccentColor(d.name);return <div key={d.id} style={{background:CARD_BG,borderRadius:14,padding:"16px 18px",border:`1px solid ${BORDER_CLR}`,borderLeft:`5px solid ${accentColor}`,marginBottom:10}}>
  <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12}}>
    ...
    <div style={{fontFamily:FB,fontSize:9,fontWeight:700,letterSpacing:1,padding:"2px 8px",borderRadius:5,
      color:d.trend==="up"?"#63D2FF":d.trend==="down"?"#FF4545":MUTED,
      background:d.trend==="up"?"#63D2FF15":d.trend==="down"?"#FF454515":BORDER_CLR}}>
...
const AVG=[["#63D2FF","#00E5FF"],["#63D2FF","#63D2FF"],["#00E5FF","#63D2FF"],["#63D2FF","#63D2FF"],["#A0A0A0","#00E5FF"],["#63D2FF","#63D2FF"],["#63D2FF","#00E5FF"],["#63D2FF","#63D2FF"]];
