...
<div style={{flex:1,padding:"16px 20px 110px",overflowY:"auto",position:"relative",zIndex:1}}>
  {/* FEED */}
  {tab==="feed"&&<div className="page fade-up" data-accent="feed">
  ...
  {/** DRILLS */}
  {tab==="drills"&&!editD&&<div className="page fade-up" data-accent="drills" id="coach-drills-management">
  ...
  {/* EVENTS */}
  {tab==="events"&&<div className="page fade-up accent-card" data-accent="events" id="coach-events-management">
  ...
  {tab==="players"&&!selP&&<div className="page" data-accent="players">
  ...
  {/* ═════════════ S&C MANAGEMENT ═════════════ */}
  {tab==="sc"&&<div className="page fade-up" data-accent="sc">
