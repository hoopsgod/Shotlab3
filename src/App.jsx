...
if(!ready)return <><Styles/><div style={{minHeight:"100dvh",background:BG,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:24,position:"relative",overflow:"hidden"}}><CourtBG opacity={.015}/><div style={{position:"relative",zIndex:1,textAlign:"center"}}><SLLogo size={72} glow/><div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginTop:16,fontFamily:FD,fontSize:12,color:T.SUB,letterSpacing:3,textTransform:"uppercase"}}><span className="refined-spinner" aria-hidden="true"/>Loading</div></div></div></>;
