...
setDataDebug(prev=>({...prev,join:{...prev.join,consumeAttemptBlocked:"no",consumeAttemptBlockedReason:"",consumeInFlightKey:consumeInFlightKey,consumeInFlightAgeMs:0,consumeFetchStarted:"yes",consumeFetchFinished:"no",consumeGuardCleared:"no",consumeGuardClearReason:""}}));
try{
...
if(acquired.mode==="joined")return await acquired.promise;
