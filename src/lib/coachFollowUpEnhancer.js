...
function CoachFollowUpPanel({context:c}){
 ...
 return React.createElement("section",{className:"coachFollowUpLedger","data-testid":"coach-follow-up-ledger","data-follow-up-state":state||"none","aria-label":`Coach follow-up for ${c.playerName}`,style:{marginTop:16,padding:16,border:"1px solid #ffffff1c",borderRadius:16,background:"#111719",color:"#f4f7f8",overflowWrap:"anywhere"}},
  ...
  React.createElement("label",{className:"coachFollowUpField is-assignment"},React.createElement("span",null,"Next assignment to deliver"),React.createElement("textarea",{value:assignment,maxLength:2000,onChange:e=>setAssignment(e.target.value),disabled:saving,"data-testid":"coach-next-assignment-input",style:{width:"100%",boxSizing:"border-box",minHeight:84,padding:11,background:"#0d1113",color:"#fff"}})),
  React.createElement("button",{type:"button",className:"coachAssignmentSave",onClick:()=>save("planned",{requireAssignment:true}),disabled:saving,"aria-busy": saving,style:{minHeight:44,marginTop:8}},"Deliver next assignment"),
  React.createElement("label",{className:"coachFollowUpField"},React.createElement("span",null,"Private coach note"),React.createElement("textarea",{value:note,maxLength:2000,onChange:e=>setNote(e.target.value),disabled:saving,style:{width:"100%",boxSizing:"border-box",minHeight:84,padding:11,background:"#0d1113",color:"#fff"}})),
  React.createElement("div",{className:"coachFollowUpActions",style:{display:"flex",gap:8,marginTop:10}},React.createElement("button",{type:"button",onClick:()=>save(primary),disabled:saving,"aria-busy": saving,style:{minHeight:44,flex:1}},state==="planned"?"Mark follow-up complete":state==="completed"?"Reopen follow-up":"Mark for follow-up"),React.createElement("button",{type:"button",onClick:()=>save("dismissed"),disabled:saving||!state,"aria-busy": saving,style:{minHeight:44,flex:1}},"Clear record")),
