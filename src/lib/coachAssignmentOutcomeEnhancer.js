...
.mcAssignmentOutcomeHead small,.mcAssignmentOutcomeMeta,.mcAssignmentOutcomeRow small,.mcAssignmentOutcomeFacts small{font-family:'Barlow Condensed','Arial Narrow',sans-serif;text-transform:uppercase;letter-spacing:.08em}
...
.mcAssignmentOutcome .mcTextLink{margin-top:11px}
...
function CoachAssignmentOutcomePanel() {
  ...
  return React.createElement(
    "article",
    { className: "mcSection mcAssignmentOutcome", "aria-labelledby": "mc-assignment-outcome-heading", "data-testid": "coach-assignment-outcome" },
