...
const buildPlayerSeasonSummaries = ({ rosterSnapshot, playerProfileSnapshot, homeScoresSnapshot, programScoresSnapshot, shotLogsSnapshot, eventRsvpSnapshot, scRsvpSnapshot, scLogSnapshot }) => buildRosterEntries(rosterSnapshot, playerProfileSnapshot).map((entry) => {
...
export function createSeasonArchive({
  ...
  const playerSeasonSummaries = buildPlayerSeasonSummaries({ rosterSnapshot, playerProfileSnapshot, homeScoresSnapshot, programScoresSnapshot, shotLogsSnapshot, eventRsvpSnapshot, scRsvpSnapshot, scLogSnapshot });
