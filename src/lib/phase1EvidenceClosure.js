...
@media(max-width:700px){
 ...
 body.mission-control-active .mcShellV3.is-mobile-shell .mcHero[data-team-identity-stage="coach-mission-control"] .mcHeroIdentity{--coach-hero-crest:clamp(104px,29vw,120px)!important;grid-template-columns:minmax(0,1fr) var(--coach-hero-crest)!important;gap:12px!important}
