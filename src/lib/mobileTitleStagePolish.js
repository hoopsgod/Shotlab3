...
export function installMobileTitleStagePolish() {
  ...
  if (document.getElementById("shotlab-mobile-title-stage-polish")) return true;
  const style = document.createElement("style");
  style.id = "shotlab-mobile-title-stage-polish";
  style.textContent = MOBILE_TITLE_STAGE_CSS;
