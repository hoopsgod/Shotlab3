...
function shouldRetryShotLogInsertWithoutClientId(error) {
  ...
  if (!pointsToShotLogId) return false;
  return haystack.includes("invalid input syntax") || haystack.includes("bigint") || haystack.includes("uuid") || haystack.includes("identity");
}
