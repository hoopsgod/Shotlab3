...
if ((source.split(phase3dAuthority).length - 1) + (source.split(oldEventAuthority).length - 1) + (source.split(eventAuthority).length - 1) + (source.split(strengthAuthority).length - 1) + (source.split(explicitRsvpStrengthAuthority).length - 1) !== 1) {
