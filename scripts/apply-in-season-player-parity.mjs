...
export function applyInSeasonPlayerParity(rawSource) {
  ...
  source = replaceOnce(source, pathBefore, pathAfter, "player In Season path mapping");
  ...
  source = replaceOnce(source, secondaryBefore, secondaryAfter, "player mobile In Season navigation");
