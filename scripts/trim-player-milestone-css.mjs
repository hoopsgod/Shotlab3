...
const compactBlock = ".milestoneCard{margin-top:14px;padding:16px;background:#1b211d;color:#fff}.milestoneTopline{display:flex;justify-content:space-between}.milestoneTopline h3{margin:5px 0 0}.milestoneTopline>strong{color:#c8ff1a;font-size:30px}.milestoneTrack{height:8px;margin-top:14px;background:#3a423c}.milestoneTrack span{display:block;height:8px;background:#c8ff1a}.milestoneFooter p{margin:0}";
