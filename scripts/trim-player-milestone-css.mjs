...
const compactBlock = ".milestoneCard{margin-top:14px;padding:16px;border-radius:18px;background:#1b211d;color:#fff}.milestoneTopline{display:flex;justify-content:space-between;gap:12px}.milestoneTopline h3{margin:5px 0 0;font-size:26px}.milestoneTopline>strong{color:var(--accent,#c8ff1a);font-size:30px}.milestoneTrack{height:8px;margin-top:14px;overflow:hidden;border-radius:9px;background:#3a423c}.milestoneTrack span{display:block;height:100%;background:var(--accent,#c8ff1a)}.milestoneFooter{margin-top:10px}.milestoneFooter p{margin:0;font-size:12px}";
