...
const compactBlock = ".milestoneCard{padding:16px;background:#1b211d;color:#fff}.milestoneTopline{display:flex;justify-content:space-between}.milestoneTopline>strong{color:#c8ff1a}.milestoneTrack{height:8px;background:#3a423c}.milestoneTrack span{display:block;height:100%;background:#c8ff1a}.milestoneFooter p{margin:0}";
