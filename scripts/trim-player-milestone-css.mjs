...
const replacements = [
  ...
  [".milestoneFooter p{max-width:620px;margin:0;color:#c9d1cb;font:550 12px/1.5 system-ui,sans-serif}", ".milestoneFooter p{margin:0;font-size:12px}"],
  [".milestoneFooter span{color:#fff;font:800 10px/1 system-ui,sans-serif;text-transform:uppercase}", ""],
  ...
  [".milestoneFooter{align-items:flex-start;flex-direction:column}", ".milestoneFooter{display:block}"],
