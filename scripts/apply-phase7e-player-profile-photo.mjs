...
const profileComment='  {/* ═════════════ PROFILE — Offseason Resume ═════════════ */}',route=`{tab==="personalization"&&<SecondaryPageShell testId="player-personalization-workspace"><SecondaryPageDecision title="Personalization" detail="Profile photo">${photoSurface}</SecondaryPageDecision></SecondaryPageShell>}\n\n`;
