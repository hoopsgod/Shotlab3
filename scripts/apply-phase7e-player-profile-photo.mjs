...
const mobileAnchor='  getPlayerNavItem("team-store",{mobileLabel:"Team Store",description:"Official team apparel and fan gear"}),',mobileItem='  getPlayerNavItem("profile",{k:"personalization",l:"Personalization",group:"team"}),';
...
const profileComment='  {/* ═════════════ PROFILE — Offseason Resume ═════════════ */}',route=`{tab==="personalization"&&<SecondaryPageShell testId="player-personalization-workspace"><SecondaryPageIntro title="Personalization" summary="Profile photo and identity." icon="profile"/>${photoSurface}</SecondaryPageShell>}\n\n`;
