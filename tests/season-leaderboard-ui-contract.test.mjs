...
test('player and coach leaderboard hubs receive team season archives', () => {
...
test('shared leaderboard hub exposes current and all-time controls', () => {
  ...
  assert.match(hubSource, /leaderboard-time-scope-current/);
  assert.match(hubSource, /leaderboard-time-scope-all_time/);
