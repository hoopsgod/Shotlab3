...
test('formats full remote persistence debug errors with message code details and hint labels', () => {
  ...
  assert.equal(formatted, 'message: new row violates row-level security policy | code: 42501 | details: Failing row contains program score | hint: Check scores insert policy');
});
