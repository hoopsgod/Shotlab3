...
test('the performance verifier locks startup App assets and total request budgets', () => {
  ...
  assert.equal(performanceBudget.maxLargestJavaScriptBytes, 600000)
  assert.equal(performanceBudget.maxStartupAppJavaScriptBytes, 600000)
  assert.equal(performanceBudget.maxStartupAppJavaScriptGzipBytes, 172000)
  ...
  assert.equal(performanceBudget.maxStartupAppCssBytes, 50000)
  assert.equal(performanceBudget.maxStartupAppCssGzipBytes, 9000)
  assert.equal(performanceBudget.maxTotalCssGzipBytes, 75500)
  assert.equal(performanceBudget.maxJavaScriptFileCount, 8)
})
