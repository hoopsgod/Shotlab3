...
test('activity feed card is rendered in player and coach homes with compact empty-state copy', () => {
  assert.match(source, /const recentPlayerActivity=deriveActivityFeedItems\(\{view:"player",user:u,events,rsvps,shotLogs,players:playerLeaderboardPlayers,scores,today,activeTeamPlayerEmails:playerActiveTeamEmailSet,activeTeamPlayerKeys:playerActiveTeamKeySet\}\)/);
