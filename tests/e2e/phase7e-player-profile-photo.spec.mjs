...
test('Coach roster renders stored player photos and restrained row color', async ({ page }) => {
  ...
  const seeded = await page.evaluate(() => {
    ...
    player.photoUrl = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=';
    player.photo_url = player.photoUrl;
